...
1. **FHIR-EHR-QC**: This module focuses on migrating data to FHIR by sourcing it from OMOP-CDM, GTF Files, and other custom files. It can also do the reverse conversion, by reading FHIR resources and persisting it in a standard OMOP-CDM database.
...
.. note::
   ...
   In this documentation, we provide detailed usage information about FHIR-EHR-QC module. However, this is only a part of EHR-Int framework which consists of other modules.
